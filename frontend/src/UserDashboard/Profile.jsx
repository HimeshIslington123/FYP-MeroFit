  ...
  return (
    <>
      <div className="px-[0px] w-full  overflow-hidden lg:px-[50px] ">
        {showedit ? (
          <>
            <form className="w-full mt-5 p-6 bg-white  border rounded-2xl border-gray-100 shadow-sm space-y-5 ">
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  onChange={onChange}
                  className="p-3 rounded-lg bg-transparent  border border-[#2bb3a3] focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none"
              ...
              <div className="flex flex-col">
                ...
                <select
                  ...
                  onChange={onChange}
                  className="p-3 rounded-lg border border-[#2bb3a3] text-black focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                >
              ...
              <button
                onClick={update}
                className="bg-[#e67e22] w-full py-[10px] text-[#fdf3e7]  text-[20px] font-normal rounded-xl"
                type="submit"
              >
                Update
              </button>
          ...
          <>
            {/* Profile Card */}
            <div className="bg-white overflow-hidden   text-black p-[20px] rounded-[20px] w-full h-[40vh] flex flex-col items-center shadow-lg">
              {/* Profile Image */}
              <div className="rounded-full border border-amber-950 overflow-hidden">
                <img
              ...
              {/* Name */}
              <div className="text-black mt-3 mb-0 flex flex-col items-center">
                <h1 className="text-[30px] m-[0] font-light">
                  {userdata.name}
                </h1>
              </div>

              {/* Info Row */}
              <div className="flex text-black opacity-90 justify-center gap-[15px] text-[15px] flex-wrap mt-2">
              ...
              <button
                ...
                className="bg-white mt-[15px] px-[15px] duration-500 py-[7px] rounded-[40px] text-black flex border-1 items-center cursor-pointer gap-2 hover:bg-black hover:border hover:border-red-100 hover:text-white"
              >
            ...
            <div className="w-full mt-[20px] flex overflow-hidden flex-wrap justify-between gap-[10px]">
              ...
              <div className="w-[45%] lg:w-[20%] flex flex-col border rounded-2xl border-gray-200 items-center justify-between  text-black rounded-[20px] p-[20px] bg-white ">
                ...
                <h3 className="text-[14px] text-center opacity-70">
                  Current Weight
                </h3>
              </div>

              {/* Height */}
              <div className="w-[45%] lg:w-[20%]  flex flex-col text-black border rounded-2xl border-gray-200 justify-between items-center rounded-[20px] p-[20px] bg-white ">
              ...
              {/* Goal */}
              <div className="w-[45%] lg:w-[20%]  text-black border  border-gray-200 justify-between items-center bg-white flex flex-col  rounded-[20px] p-[20px] ">
                <div className="bg-[#9333EA]/20  rounded-[10px] p-[10px]">
                  <Target size={40} color="#9333EA" />
                </div>
                <h1 className="text-[23px] text-center font-semibold mt-2">
                  {userdata.goal}
                </h1>
              ...
              {/* Target Weight */}
              <div className="w-[45%] lg:w-[20%]  text-black bg-white flex flex-col justify-between items-center rounded-[20px] p-[20px] border r border-gray-200">
            ...
            {/* Personal Info */}
            <div className="w-full p-[20px]  border rounded-2xl border-gray-200 bg-white text-black mt-3">
              <h1 className="opacity-55 mb-[10px]"> Personal Information</h1>

              <div className="w-full flex text-[14px] flex-col gap-[20px]">
                <div className="flex w-full pb-[10px] border-b-1 border-black/15 justify-between">
