...
const Post = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!caption && !file) return alert("Caption or image is required!");
        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="flex justify-between items-start mb-2">
            <div>
              ...
              <p className="text-lg text-[#2bb3a3] mt-2">
          ...
          {showForm && (
            <form
              ...
              className="bg-white p-6 rounded-[2rem] shadow-sm border border-gray-100 animate-in fade-in slide-in-from-top-4 duration-300"
            >
              <textarea
                value={caption}
              ...
              <div className="mt-4 flex flex-wrap gap-4 items-center justify-between">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    type="submit"
                    className="bg-[#2bb3a3] text-white px-8 py-2 rounded-xl "
                  >
                    Post
                  </button>
                </div>
          ...
          <div className="space-y-6">
            {displayPosts.map((post) => (
              <div
                key={post._id}
                className="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 group transition-all hover:shadow-md"
              >
                ...
                <div className="mt-6">
                  ...
                  {post.image && (
                    <img
                      src={post.image}
                      alt=""
                      className="w-full rounded-[1.5rem] object-contain max-h-[450px] shadow-inner bg-gray-50"
                    />
                  )}
                </div>
              </div>
