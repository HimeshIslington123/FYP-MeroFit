...
const UserPayment = () => {
  ...
  return (
    <div className=" min-h-screen w-full text-black flex flex-col items-center p-5 lg:p-10">
      ...
      <div className="flex flex-wrap justify-between gap-6 w-full max-w-6xl">
        {packages.map((pkg, index) => (
          ...
          >
            ...
            <p className="text-[15px] text-gray-600">Membership</p>
            ...
            <button
              className="bg-[#1abc9c] transition-all px-5 py-2 mt-4 rounded-lg text-white font-light"
